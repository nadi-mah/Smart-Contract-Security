...
### [I-4] Events of `TSwapPool.sol` should be indexed if there are more that three parameters.

**Description:** 

In Solidity, it is recommended to use the indexed keyword for up to three parameters in events. This allows those parameters to be searchable in transaction logs. Unindexed parameters make it more difficult to filter and track events on the blockchain.
