...
contract L1BossBridge is Ownable, Pausable, ReentrancyGuard {
    ...
    // @audit-high funds approved to the bridge can be stolen
    function depositTokensToL2(
        ...
        // @audit-high arbitary from in transferFrom
        // if a user approve the bridge, any other user can steal their fund
        token.safeTransferFrom(from, address(vault), amount);

        // Our off-chain service picks up this event and mints the corresponding tokens on L2
        // @audit-info should follow the CEI
