...
// @audit-low the used interface should be implemented
// import {IThunderLoan.sol} from "src/interfaces/IThunderLoan.sol";
    ...
    OracleUpgradeable
{
    ...
    /*//////////////////////////////////////////////////////////////
                           EXTERNAL FUNCTIONS
    //////////////////////////////////////////////////////////////*/
    // @audit/info initializers can be front run, anyone can call the initialize if we do not
    function initialize(address tswapAddress) external initializer {
        __Ownable_init(msg.sender);
        __UUPSUpgradeable_init();
        // @audit/info "tswapAddress" name is not good it is better to be the same as OracleUpgradeable parameters "poolFactoryAddress"
        __Oracle_init(tswapAddress); // using tswap as kind of oracle
        s_feePrecision = 1e18; // @written in aderyn
        s_flashLoanFee = 3e15; // 0.3% ETH fee
    }
    // @audit/info where the fuck is the natspec?
    function deposit(
        IERC20 token,
        uint256 amount
        ...
        // @audit follow up, why this is calculating fee of the thunder loan??? this seems sus
        // @audit-high
    ...
    // @audit-low different parameter type
    ...
    function getCalculatedFee(
        ...
        // @audit/high oracle manipulation
